...
-- -----------------------------------------------------
-- Placeholder table for view `inter`.`mod_investidor_evento_view`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `inter`.`mod_investidor_evento_view` (`mod_codigo` INT, `mod_nome` INT, `mod_habilitado` INT, `mod_editar` INT, `mod_descricao` INT, `tim_codigo` INT);

-- -----------------------------------------------------
-- Placeholder table for view `inter`.`mod_financeira_evento_view`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `inter`.`mod_financeira_evento_view` (`mod_codigo` INT, `mod_nome` INT, `mod_habilitado` INT, `mod_editar` INT, `mod_descricao` INT, `tim_codigo` INT);

-- -----------------------------------------------------
-- Placeholder table for view `inter`.`mod_empresarial_evento_view`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `inter`.`mod_empresarial_evento_view` (`mod_codigo` INT, `mod_nome` INT, `mod_habilitado` INT, `mod_editar` INT, `mod_descricao` INT, `tim_codigo` INT);
...
-- -----------------------------------------------------
-- View `inter`.`mod_investidor_evento_view`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `inter`.`mod_investidor_evento_view` ;
DROP TABLE IF EXISTS `inter`.`mod_investidor_evento_view`;
USE `inter`;
CREATE  OR REPLACE VIEW mod_investidor_evento_view AS
SELECT mol.* FROM mod_modelos mol
INNER JOIN mev_modelosEventos mev USING(mod_codigo)
INNER JOIN eve_eventos eve USING(eve_codigo)
WHERE mol.tim_codigo = 1 AND eve.eve_ativo = true;


-- -----------------------------------------------------
-- View `inter`.`mod_financeira_evento_view`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `inter`.`mod_financeira_evento_view` ;
DROP TABLE IF EXISTS `inter`.`mod_financeira_evento_view`;
USE `inter`;
CREATE  OR REPLACE VIEW mod_financeira_evento_view AS
SELECT mol.* FROM mod_modelos mol
INNER JOIN mev_modelosEventos mev USING(mod_codigo)
INNER JOIN eve_eventos eve USING(eve_codigo)
WHERE mol.tim_codigo = 2 AND eve.eve_ativo = true;

-- -----------------------------------------------------
-- View `inter`.`mod_empresarial_evento_view`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `inter`.`mod_empresarial_evento_view` ;
DROP TABLE IF EXISTS `inter`.`mod_empresarial_evento_view`;
USE `inter`;
CREATE  OR REPLACE VIEW mod_empresarial_evento_view AS
SELECT mol.* FROM mod_modelos mol
INNER JOIN mev_modelosEventos mev USING(mod_codigo)
INNER JOIN eve_eventos eve USING(eve_codigo)
WHERE mol.tim_codigo = 3 AND eve.eve_ativo = true;
