...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:MultiView ID="mvwEmpresarial" runat="server">
        ...
        <asp:View ID="ViewEscolha" runat="server">
            ...
            <input type="button" value="Cancelar" class="botao" onclick="cancelar()" />
            <asp:Button ID="Button1" runat="server" Text="Nova Questão" CssClass="botao" />
            <asp:Button ID="Button2" runat="server" Text="Finalizar" CssClass="botao" />
        </asp:View>

        <asp:View ID="ViewDissertativa" runat="server">
            <asp:Label ID="Label2" runat="server" Text="Nicholas não quer mudar o banco de dados." CssClass="texto"></asp:Label>
            <br />
            <input type="button" value="Cancelar" class="botao" onclick="cancelar()" />
